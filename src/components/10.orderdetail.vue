                            ...
                            <div class="right-auto">
                                <div class="bg-wrap" style="min-height: 765px;">
                                    ...
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link :to="'/payOrder/'+orderinfo.id" v-if="orderinfo.orderstatus==1" class="btn-pay">去付款</router-link>
                                                <a href="javascript:;" class="btn-pay" @click="sign(orderinfo.id)" v-if="orderinfo.orderstatus>1&&orderinfo.orderstatus<4">签收</a>
                                                <!---->
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
                                    ...
                                    <div class="form-box accept-box">
                                        ...
                                        <dl class="form-group">
                                            <dt>顾客姓名：</dt>
                                            <dd>{{orderinfo.accept_name?orderinfo.accept_name:"匿名用户"}}</dd>
                                        </dl>
                                        <dl class="form-group">
                                            <dt>送货地址：</dt>
                                            <dd>{{orderinfo.area}}
